  ...
  headers: async () => [
      {
          ...
          { key: "X-XSS-Protection", value: "1; mode=block" },
        {
          ...
          value: [
            ...
            "connect-src 'self' https://*.supabase.co wss://*.supabase.co https://*.walletconnect.com wss://*.walletconnect.com https://*.rpc.alchemyapi.io wss://*.rpc.alchemyapi.io https://*.alchemy.com https://o4511795317768192.ingest.de.sentry.io https://us.i.posthog.com",
            "frame-src 'self' https://*.walletconnect.com https://*.walletconnect.org https://*.walletlink.org",
