...
- **Verified** — lint + typecheck clean (pre-existing warnings only), 178/178 tests green (auth actions tests updated for the generateLink flows; `createAdminClient` mocked).
