...
VALUES
  ('virtual-standard',     'Virtual Standard',     'virtual', 'Digital-first debit card for everyday spending.',  5,   0,    ARRAY['polygon','ethereum','arbitrum'], ARRAY['USDC','USDT'], 'USD', '/card-art/virtual-standard.svg',   '["Instant issuance","Virtual card details","Online purchases","ATM access","Free virtual card"]'),
  ('virtual-premium',      'Virtual Premium',      'virtual', 'Premium digital card with higher limits and rewards.', 15,  15,  ARRAY['polygon','ethereum','arbitrum','optimism','base'], ARRAY['USDC','USDT','DAI'], 'USD', '/card-art/virtual-premium.svg', '["Instant issuance","Priority support","2% cashback","Higher limits","Crypto cashback"]'),
  ('physical-standard',    'Physical Standard',    'physical', 'Metal debit card shipped worldwide.',  10,  0,    ARRAY['polygon','ethereum','arbitrum'], ARRAY['USDC','USDT'], 'USD', '/card-art/physical-standard.svg',   '["Metal card","Free shipping","ATM withdrawals","Online purchases","Custom design"]'),
  ('physical-premium',     'Physical Premium',     'physical', 'Premium metal card with priority shipping and rewards.',  25,  25, ARRAY['polygon','ethereum','arbitrum','optimism','base','solana'], ARRAY['USDC','USDT','DAI'], 'USD', '/card-art/physical-premium.svg', '["Brushed metal finish","Priority shipping","3% cashback","Concierge service","Exclusive events","Custom engraving"]'),
  ('physical-black',       'Physical Black',       'physical', 'Exclusive black metal card. Invite only.',  50,  50, ARRAY['polygon','ethereum','arbitrum','optimism','base','solana'], ARRAY['USDC','USDT','DAI'], 'USD', '/card-art/physical-black.svg',     '["Black carbon fiber","VIP shipping","5% cashback","Personal concierge","Airport lounge access","Invite-only events","Custom engraving","Dedicated account manager"]')
...
VALUES
  ('general',          '{"site_name":"TWallet Card","support_email":"support@twalletservices.com","support_phone":"+1-800-TWALLET","platform_fee_percent":1.5,"min_order_amount":5,"max_order_amount":10000,"default_currency":"USD"}'),
