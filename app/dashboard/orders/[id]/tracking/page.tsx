          ...
          <CardContent>
            <div className="flex flex-col items-center py-8 text-center">
              <div className="flex h-20 w-20 items-center justify-center rounded-full bg-brand-50">
                <Package className="h-10 w-10 text-brand-600" aria-hidden="true" />
              </div>
              <h3 className="mt-4 text-lg font-semibold text-slate-900 capitalize">{order.status}</h3>
          ...
          <CardContent className="space-y-3 text-sm">
            ...
            {order.delivered_at && (
              <div className="flex justify-between">
                ...
                <span className="text-slate-700">{new Date(order.delivered_at).toLocaleDateString()}</span>
              </div>
            )}
          </CardContent>
        </Card>
