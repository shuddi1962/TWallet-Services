    ...
    >
      <div className="flex items-center justify-between border-b border-white/[0.05] px-5 py-4">
        <div>
          ...
          <p className="text-xs text-surface-500">WalletConnect · 300+ wallets</p>
        </div>
        {isConnected && (
        ...
        {!isConnected || !address ? (
          <div className="flex flex-col items-center py-8 text-center">
            ...
            <p className="mt-1 max-w-xs text-sm text-surface-400">
              Official WalletConnect modal: QR + MetaMask, Trust, Binance, Ledger and more.
            </p>
            <Button className="mt-5 rounded-full" onClick={() => void openWallet()}>
              Connect Wallet
            </Button>
          </div>
        ) : (
