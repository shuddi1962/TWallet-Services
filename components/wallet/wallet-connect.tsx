            ...
            <div>
              ...
              <CardDescription className="mt-1">
                {isConnected
                  ...
                  : "Link a wallet to order cards and pay on-chain"}
              </CardDescription>
            </div>
            {isConnected && (
          ...
          {!isConnected ? (
            <div className="flex flex-col items-center justify-center py-10 text-center">
              ...
              <p className="mt-2 max-w-sm text-sm text-surface-400">
                MetaMask, Trust Wallet, Coinbase Wallet, Rainbow — connect via browser or WalletConnect.
              </p>
              <Button className="mt-6 rounded-full px-8" onClick={() => openWallet()} disabled={connecting}>
