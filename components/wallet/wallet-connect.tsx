        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <CardDescription className="mt-1">
              {isConnected
                ? "Ready for crypto payments to the platform receiving address"
                : "WalletConnect · MetaMask · Trust · Binance · 300+ wallets"}
            </CardDescription>
          </div>
          {isConnected && (
        ...
        {!isConnected ? (
          <div className="flex flex-col items-center justify-center py-10 text-center">
            ...
            <p className="mt-2 max-w-sm text-sm text-surface-400">
              Opens the official WalletConnect modal with QR code and full wallet list. You always keep your keys.
            </p>
            <Button className="mt-6 rounded-full px-8" onClick={() => void openWallet()}>
          ...
          <div className="space-y-4">
            <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-brand-600 via-brand-700 to-accent-700 p-5 text-white shadow-lg shadow-brand-600/20">
