  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          {isConnected ? "Your wallet is connected and ready to use" : "Connect your wallet to start ordering cards and making crypto payments"}
        </CardDescription>
      </CardHeader>
      <CardContent>
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="mt-1 max-w-sm text-sm text-surface-400">
            {isConnected
              ...
              : "Connect your wallet to start ordering cards and making crypto payments."}
          </p>
