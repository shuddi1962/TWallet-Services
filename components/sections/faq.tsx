...
const faqs = [
  { question: "Is TWALLET really non-custodial?", answer: "Yes. We never collect, store, or request your recovery phrase or private keys. You connect Trust Wallet using WalletConnect technology, and you sign every transaction yourself. The platform never signs or broadcasts on your behalf." },
  { question: "How does payment verification work?", answer: "When you place an order, we generate a unique receiving wallet address and the exact crypto amount. After you send the payment from Trust Wallet, our system independently verifies the transaction on-chain — checking the correct address, amount, chain, and required confirmations. Only then is your order marked as paid." },
  { question: "Why Trust Wallet?", answer: "Trust Wallet offers a simple and secure way to connect and pay using cryptocurrency. It is the recommended wallet for TWallet Services, providing a seamless experience for ordering cards and making crypto payments." },
  { question: "Why does the platform use WalletConnect?", answer: "WalletConnect is the secure connection technology that allows Trust Wallet to communicate safely with TWallet Services. Customers only interact with Trust Wallet while WalletConnect works behind the scenes." },
